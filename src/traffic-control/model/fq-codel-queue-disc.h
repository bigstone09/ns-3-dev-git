...
#ifndef FQ_CODEL_QUEUE_DISC_H
#define FQ_CODEL_QUEUE_DISC_H
 ...
 */
class Fq_CoDelQueue : public QueueDisc {
public:
  static TypeId GetTypeId (void);
  /**
...
private:
  ...
  UniformRandomVariable psource;
  mutable uint32_t peturbation;
  uint32_t m_quantum;
  uint32_t backlog;

  std::list<Ptr<Fq_CoDelSlot> > m_newFlows;
  std::list<Ptr<Fq_CoDelSlot> > m_oldFlows;
};

} // namespace ns3

#endif /* FQ_CODEL_QUEUE_DISC_H */
